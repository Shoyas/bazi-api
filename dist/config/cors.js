...
exports.dashboardCorsOptions = exports.openCorsOptions = void 0;
 ...
 */
const getRuntimeOrigins = () => {
    if (!index_1.default.cors.origins)
        return [];
    return index_1.default.cors.origins.split(',').map((o) => o.trim()).filter(Boolean);
};
/**
 ...
 */
exports.default = exports.dashboardCorsOptions;
